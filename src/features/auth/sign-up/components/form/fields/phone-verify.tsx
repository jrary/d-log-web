...
import { Verify } from "@features/auth/sign-up/components/form/components/verify"
import { RequestButton } from "@features/auth/sign-up/components/form/styled"
import { useRequestCodeMutation } from "@features/auth/sign-up/queries/useRequestCodeMutation"
import { useVerifyCodeMutation } from "@features/auth/sign-up/queries/useVerifyCodeMutation"
...
import type {
  VerifyRef,
  VerifyState,
} from "@features/auth/sign-up/components/form/components/verify"
...
export function PhoneVerifyField() {
  const { values, errors, setFieldValue, setFieldError, getFieldProps } =
        ...
        <FormControl.Content>
          ...
          {verificationState !== "success" && (
            <RequestButton
              ...
              <Text>{status === "idle" ? "인증요청" : "재요청"}</Text>
            </RequestButton>
          )}
          {verificationState === "success" && (
            <RequestButton type="button" disabled>
              <Text>인증완료</Text>
            </RequestButton>
          )}
        </FormControl.Content>
